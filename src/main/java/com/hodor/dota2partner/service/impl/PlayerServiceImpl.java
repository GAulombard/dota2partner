...
public class PlayerServiceImpl implements PlayerService {
    ...
    private ODPlayersService openDotaApiService;
    private String openDotaApiUrl = "https://api.opendota.com/api";
    private static final DecimalFormat df = new DecimalFormat("0.00");

    @Autowired
    public PlayerServiceImpl(PlayerRepository playerRepository, PasswordEncoder passwordEncoder, ODPlayersService openDotaApiService) {
    ...
    @Override
    public void refreshPlayerData(Long steamId32) throws OpenDotaApiException {

        log.info("Service - fetching datas for player - " + steamId32);
        ...
        ObjectNode dataPlayer = openDotaApiService.getPlayerData(steamId32);
        log.info(dataPlayer.toString());
        ObjectNode winLossCount = openDotaApiService.getWinLossCount(steamId32);
        log.info(winLossCount.toString());
